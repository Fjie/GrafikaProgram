...
fun View.animateWidth(toValue: Int, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateWidthBy(byValue: Int, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator)
        = animateWidth(width + byValue, duration, interpolator)

fun View.animateHeight(toValue: Int, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateHeightBy(byValue: Int, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator)
...
fun View.animateX(toValue: Float, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateXBy(toValue: Float, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator)
        = animateX(translationX + toValue, duration, interpolator)

fun View.animateY(toValue: Float, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator): AnimatePropsWrapper {
...
fun View.animateYBy(toValue: Float, duration: Long = me.fanjie.grafikaprogram.ext.duration, interpolator: Interpolator = me.fanjie.grafikaprogram.ext.interpolator)
